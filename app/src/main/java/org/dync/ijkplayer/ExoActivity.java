...
//        }
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            RenderersFactory renderersFactory =
                    buildRenderersFactory(preferExtensionDecoders);
    ...
    private MediaSource createTopLevelMediaSource(Intent intent) {
        ...
        samples = new Sample.UriSample(
                /* name= */ null,
                uris[0],
                extension,
                isLive,
                Sample.DrmInfo.createFromIntent(intent, extrasKeySuffix),
                adTagUri,
                /* sphericalStereoMode= */ null,
                Sample.SubtitleInfo.createFromIntent(intent, extrasKeySuffix));
        ...
        MediaSource mediaSources = createLeafMediaSource(samples);
        Sample.SubtitleInfo subtitleInfo = samples.subtitleInfo;
        if (subtitleInfo != null) {
            ...
            mediaSources = new MergingMediaSource(mediaSources, subtitleMediaSource);
        }
//        MediaSource mediaSource =
//                mediaSources.length == 1 ? mediaSources : new ConcatenatingMediaSource(mediaSources);

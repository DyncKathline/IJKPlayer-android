...
import org.dync.exo.util.IjkWindowVideoView;
import org.dync.exo.util.PlayerController;
import org.dync.exo.util.Settings;
import org.dync.exo.util.WindowManagerUtil;
...
//        playIcon.setEnabled(false);
    ...
    private void showVideoInfo(IMediaPlayer mMediaPlayer) {
        ...
        if (mMediaPlayer != null && mMediaPlayer instanceof IjkExoMediaPlayer) {
